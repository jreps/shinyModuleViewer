...
getControlResults <- function(cohortMethodResult, connection, targetId, comparatorId, analysisId, databaseId = NULL, includePositiveControls = TRUE) {
...
getCmFollowUpDist <- function(cmFollowUpDist,
                              connection,
                              targetId,
                              comparatorId,
                              outcomeId,
